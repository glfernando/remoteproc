...
static int rprm_gptimer_get_info(void *handle, char *buf)
{
	struct rprm_gpt_depot *gptd = handle;
...
static int rprm_sdma_get_info(void *handle, char *buf)
{
	struct rprm_sdma *sd = handle;
	int i, ret = 0;
...
static int rprm_auxclk_get_info(void *handle, char *buf)
{
	struct rprm_auxclk_depot *acd = handle;
