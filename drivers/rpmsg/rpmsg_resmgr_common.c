...
static int rprm_gpio_get_info(void *handle, char *buf)
{
	struct rprm_gpio *gpio = handle;
...
static int rprm_regulator_get_info(void *handle, char *buf)
{
	struct rprm_regulator_depot *rd = handle;
...
static int rprm_i2c_get_info(void *handle, char *buf)
{
	struct rprm_i2c_depot *i2cd = handle;
