...
static int rprm_gpio_request(void **handle, void *args, size_t len)
{
	...
	*handle = memcpy(gd, gpio, sizeof(*gpio));
...
static int rprm_gpio_sprint(void *handle, char *buf)
{
	struct rprm_gpio *gpio = handle;
...
static int rprm_regulator_sprint(void *handle, char *buf)
{
	struct rprm_regulator_depot *rd = handle;
...
static int rprm_i2c_sprint(void *handle, char *buf)
{
	struct rprm_i2c_depot *i2cd = handle;
